...
void loop() {
  ...
  if (RTC.read(tm)) {
    ...
    if (logHour != tm.Hour)
    {
      logMinute = 0;     
      logHour = tm.Hour;
      //lastTimestamp = logHour*60 + logMinute; //tm.Hour*60 + tm.Minute; 
    }
